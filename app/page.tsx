...
const categories: Category[] = [
  {
    ...
    tools: [
      ...
      },
      {
        id: "markdown",
        title: "Markdown 在线编辑",
        description: "Markdown 在线编辑、实时预览和导出",
      ...
      },
      {
        id: "png-to-svg",
        title: "PNG 转 SVG",
        description: "将 PNG 包装为保持透明度的 SVG",
      ...
      },
      {
        id: "mermaid",
        title: "Mermaid 在线编辑",
        description: "编辑 Mermaid 图表并实时生成 SVG",
        icon: <FileCode className="h-6 w-6" />,
        href: "/mermaid",
        color: "text-sky-600",
      },
